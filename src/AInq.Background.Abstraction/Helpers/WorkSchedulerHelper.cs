...
public static class WorkSchedulerHelper
{
    ...
    public static void AddDelayedWork<TResult>(this IServiceProvider provider, IWork<TResult> work, TimeSpan delay,
    ...
    public static void AddDelayedAsyncWork<TResult>(this IServiceProvider provider, IAsyncWork<TResult> work, TimeSpan delay,
        CancellationToken cancellation = default)
        => (provider.GetService(typeof(IWorkScheduler)) as IWorkScheduler ?? throw new InvalidOperationException("No Work Scheduler service found"))
            .AddDelayedAsyncWork(work, delay, cancellation);
    ...
    public static void AddDelayedAsyncWork<TAsyncWork, TResult>(this IServiceProvider provider, TimeSpan delay,
        CancellationToken cancellation = default)
    ...
    public static void AddScheduledWork<TResult>(this IServiceProvider provider, IWork<TResult> work, DateTime time,
        CancellationToken cancellation = default)
        => (provider.GetService(typeof(IWorkScheduler)) as IWorkScheduler ?? throw new InvalidOperationException("No Work Scheduler service found"))
            .AddScheduledWork(work, time, cancellation);
    ...
    public static void AddScheduledAsyncWork<TResult>(this IServiceProvider provider, IAsyncWork<TResult> work, DateTime time,
        CancellationToken cancellation = default)
        => (provider.GetService(typeof(IWorkScheduler)) as IWorkScheduler ?? throw new InvalidOperationException("No Work Scheduler service found"))
            .AddScheduledAsyncWork(work, time, cancellation);
    ...
    public static void AddScheduledAsyncWork<TAsyncWork, TResult>(this IServiceProvider provider, DateTime time,
        CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>
        => (provider.GetService(typeof(IWorkScheduler)) as IWorkScheduler ?? throw new InvalidOperationException("No Work Scheduler service found"))
