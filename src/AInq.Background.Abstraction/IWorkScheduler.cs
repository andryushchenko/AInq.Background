...
public interface IWorkScheduler
{
    ...
    void AddDelayedWork<TResult, TWork>(TimeSpan delay, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddDelayedAsyncWork<TAsyncWork>(TimeSpan delay, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddDelayedAsyncWork<TResult, TAsyncWork>(TimeSpan delay, CancellationToken cancellation = default)
    ...
    void AddDelayedQueueWork<TResult, TWork>(TimeSpan delay, int maxAttempt = 1, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddDelayedAsyncQueueWork<TAsyncWork>(TimeSpan delay, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddDelayedAsyncQueueWork<TResult, TAsyncWork>(TimeSpan delay, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>;
    ...
    void AddScheduledWork<TResult, TWork>(DateTime time, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddScheduledAsyncWork<TAsyncWork>(DateTime time, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddScheduledAsyncWork<TResult, TAsyncWork>(DateTime time, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>;
    ...
    void AddScheduledQueueWork<TResult, TWork>(DateTime time, int maxAttempt = 1, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddScheduledAsyncQueueWork<TAsyncWork>(DateTime time, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddScheduledAsyncQueueWork<TResult, TAsyncWork>(DateTime time, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>;
    ...
    void AddCronWork<TResult, TWork>(string cronExpression, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddCronAsyncWork<TAsyncWork>(string cronExpression, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddCronAsyncWork<TResult, TAsyncWork>(string cronExpression, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>;
    ...
    void AddCronQueueWork<TResult, TWork>(string cronExpression, int maxAttempt = 1, CancellationToken cancellation = default)
        where TWork : IWork<TResult>;

    void AddCronAsyncQueueWork<TAsyncWork>(string cronExpression, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork;

    void AddCronAsyncQueueWork<TResult, TAsyncWork>(string cronExpression, int maxAttempt = 1, CancellationToken cancellation = default)
        where TAsyncWork : IAsyncWork<TResult>;
}
