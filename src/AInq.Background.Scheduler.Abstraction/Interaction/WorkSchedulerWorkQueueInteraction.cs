...
#region DelayedQueue
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="delay" /> isn't greater than 00:00:00.000 </exception>
        [PublicAPI]
        public Task AddScheduledAsyncQueueWork(IAsyncWork asyncWork, TimeSpan delay, int priority = 0, int attemptsCount = 1,
            CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddScheduledAsyncWork(CreateQueuedAsyncWork(
                    asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)),
                    priority,
                    attemptsCount),
                delay,
                cancellation);
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="delay" /> isn't greater than 00:00:00.000 </exception>
        [PublicAPI]
        public Task<TResult> AddScheduledAsyncQueueWork<TResult>(IAsyncWork<TResult> asyncWork, TimeSpan delay, int priority = 0,
...
#region ScheduledQueue
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="time" /> isn't greater than current time </exception>
        [PublicAPI]
        public Task AddScheduledAsyncQueueWork(IAsyncWork asyncWork, DateTime time, int priority = 0, int attemptsCount = 1,
            CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddScheduledAsyncWork(CreateQueuedAsyncWork(
                    asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)),
                    priority,
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="time" /> isn't greater than current time </exception>
        [PublicAPI]
        public Task<TResult> AddScheduledAsyncQueueWork<TResult>(IAsyncWork<TResult> asyncWork, DateTime time, int priority = 0,
            int attemptsCount = 1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddScheduledAsyncWork(CreateQueuedAsyncWork(
                    asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)),
                    priority,
...
#region CronQueue
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Maybe<Exception>> AddCronAsyncQueueWork(IAsyncWork asyncWork, string cronExpression, int priority = 0,
            int attemptsCount = 1, int execCount = -1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddCronAsyncWork(
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Try<TResult>> AddCronAsyncQueueWork<TResult>(IAsyncWork<TResult> asyncWork, string cronExpression, int priority = 0,
            int attemptsCount = 1, int execCount = -1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddCronAsyncWork(
                CreateQueuedAsyncWork(asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)), priority, attemptsCount),
                cronExpression ?? throw new ArgumentNullException(nameof(cronExpression)),
...
#region RepeatedScheduledQueue
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="repeatDelay" /> isn't greater than 00:00:00.000 or <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Maybe<Exception>> AddRepeatedAsyncQueueWork(IAsyncWork asyncWork, DateTime starTime, TimeSpan repeatDelay,
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="repeatDelay" /> isn't greater than 00:00:00.000 or <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Try<TResult>> AddRepeatedAsyncQueueWork<TResult>(IAsyncWork<TResult> asyncWork, DateTime starTime, TimeSpan repeatDelay,
            int priority = 0, int attemptsCount = 1, int execCount = -1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddRepeatedAsyncWork(
                CreateQueuedAsyncWork(asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)), priority, attemptsCount),
                starTime,
...
#region RepeatedDelayedQueue
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="repeatDelay" /> isn't greater than 00:00:00.000 or <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Maybe<Exception>> AddRepeatedAsyncQueueWork(IAsyncWork asyncWork, TimeSpan startDelay, TimeSpan repeatDelay,
            int priority = 0, int attemptsCount = 1, int execCount = -1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddRepeatedAsyncWork(
                CreateQueuedAsyncWork(asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)), priority, attemptsCount),
                startDelay,
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown if <paramref name="repeatDelay" /> isn't greater than 00:00:00.000 or <paramref name="execCount" /> is 0 or less than -1 </exception>
        [PublicAPI]
        public IObservable<Try<TResult>> AddRepeatedAsyncQueueWork<TResult>(IAsyncWork<TResult> asyncWork, TimeSpan startDelay, TimeSpan repeatDelay,
            int priority = 0, int attemptsCount = 1, int execCount = -1, CancellationToken cancellation = default)
            => (scheduler ?? throw new ArgumentNullException(nameof(scheduler))).AddRepeatedAsyncWork(
                CreateQueuedAsyncWork(asyncWork ?? throw new ArgumentNullException(nameof(asyncWork)), priority, attemptsCount),
                startDelay,
