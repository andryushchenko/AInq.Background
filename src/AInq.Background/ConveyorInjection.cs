...
public static class ConveyorInjection
{
    ...
    extension(IServiceCollection services)
    {
        ...
        [PublicAPI]
        public IConveyor<TData, TResult> CreateConveyor<TData, TResult>(IConveyorMachine<TData, TResult> conveyorMachine,
        ...
        [PublicAPI]
        public IServiceCollection AddConveyor<TData, TResult>(IConveyorMachine<TData, TResult> conveyorMachine, int maxAttempts = int.MaxValue)
            where TData : notnull
            => (services ?? throw new ArgumentNullException(nameof(services))).Any(service
                => service.ImplementationType == typeof(IConveyor<TData, TResult>))
                ? throw new InvalidOperationException("Service already exists")
                : services.AddSingleton(services.CreateConveyor(conveyorMachine, maxAttempts));
        ...
        /// <typeparam name="TResult"> Processing result type </typeparam>
        [PublicAPI]
        public IPriorityConveyor<TData, TResult> CreatePriorityConveyor<TData, TResult>(IConveyorMachine<TData, TResult> conveyorMachine,
        ...
        /// <exception cref="InvalidOperationException"> Thrown if service already exists </exception>
        [PublicAPI]
        public IServiceCollection AddPriorityConveyor<TData, TResult>(IConveyorMachine<TData, TResult> conveyorMachine, int maxPriority = 100,
            int maxAttempts = int.MaxValue)
            where TData : notnull
        {
            _ = services ?? throw new ArgumentNullException(nameof(services));
        ...
        [PublicAPI]
        public IConveyor<TData, TResult> CreateConveyor<TData, TResult>(IEnumerable<IConveyorMachine<TData, TResult>> conveyorMachines,
            int maxAttempts = int.MaxValue)
            where TData : notnull
        {
            _ = services ?? throw new ArgumentNullException(nameof(services));
        ...
        /// <exception cref="ArgumentException"> Thrown if <paramref name="conveyorMachines" /> collection is empty </exception>
        [PublicAPI]
        public IServiceCollection AddConveyor<TData, TResult>(IEnumerable<IConveyorMachine<TData, TResult>> conveyorMachines,
            int maxAttempts = int.MaxValue)
            where TData : notnull
            => (services ?? throw new ArgumentNullException(nameof(services))).Any(service
                => service.ImplementationType == typeof(IConveyor<TData, TResult>))
                ? throw new InvalidOperationException("Service already exists")
                : services.AddSingleton(services.CreateConveyor(conveyorMachines, maxAttempts));
        ...
        /// <exception cref="ArgumentException"> Thrown if <paramref name="conveyorMachines" /> collection is empty </exception>
        [PublicAPI]
        public IPriorityConveyor<TData, TResult> CreatePriorityConveyor<TData, TResult>(
        ...
        /// <exception cref="ArgumentException"> Thrown if <paramref name="conveyorMachines" /> collection is empty </exception>
        [PublicAPI]
        public IServiceCollection AddPriorityConveyor<TData, TResult>(IEnumerable<IConveyorMachine<TData, TResult>> conveyorMachines,
            int maxPriority = 100, int maxAttempts = int.MaxValue)
            where TData : notnull
        {
            _ = services ?? throw new ArgumentNullException(nameof(services));
        ...
        [PublicAPI]
        public IConveyor<TData, TResult> CreateConveyor<TData, TResult>(
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IServiceCollection AddConveyor<TData, TResult>(Func<IServiceProvider, IConveyorMachine<TData, TResult>> conveyorMachineFactory,
            ReuseStrategy strategy, int maxParallelMachines = 1, int maxAttempts = int.MaxValue)
            where TData : notnull
            => (services ?? throw new ArgumentNullException(nameof(services))).Any(service
                => service.ImplementationType == typeof(IConveyor<TData, TResult>))
                ? throw new InvalidOperationException("Service already exists")
                : services.AddSingleton(services.CreateConveyor(conveyorMachineFactory, strategy, maxParallelMachines, maxAttempts));
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IServiceCollection AddPriorityConveyor<TData, TResult>(Func<IServiceProvider, IConveyorMachine<TData, TResult>> conveyorMachineFactory,
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IConveyor<TData, TResult> CreateConveyor<TData, TResult, TConveyorMachine>(ReuseStrategy strategy, int maxParallelMachines = 1,
            int maxAttempts = int.MaxValue)
            where TData : notnull
            where TConveyorMachine : IConveyorMachine<TData, TResult>
            => (services ?? throw new ArgumentNullException(nameof(services))).CreateConveyor(
                provider => provider.GetRequiredService<TConveyorMachine>(),
                strategy,
                maxParallelMachines,
                maxAttempts);
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IServiceCollection AddConveyor<TData, TResult, TConveyorMachine>(ReuseStrategy strategy, int maxParallelMachines = 1,
            int maxAttempts = int.MaxValue)
            where TData : notnull
            where TConveyorMachine : IConveyorMachine<TData, TResult>
            => (services ?? throw new ArgumentNullException(nameof(services))).AddConveyor(
                provider => provider.GetRequiredService<TConveyorMachine>(),
                strategy,
                maxParallelMachines,
                maxAttempts);
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IPriorityConveyor<TData, TResult> CreatePriorityConveyor<TData, TResult, TConveyorMachine>(ReuseStrategy strategy,
            int maxParallelMachines = 1, int maxPriority = 100, int maxAttempts = int.MaxValue)
            where TData : notnull
            where TConveyorMachine : IConveyorMachine<TData, TResult>
            => (services ?? throw new ArgumentNullException(nameof(services))).CreatePriorityConveyor(
                provider => provider.GetRequiredService<TConveyorMachine>(),
                strategy,
                maxParallelMachines,
                maxPriority,
        ...
        /// <exception cref="InvalidEnumArgumentException"> Thrown if <paramref name="strategy" /> has incorrect value </exception>
        [PublicAPI]
        public IServiceCollection AddPriorityConveyor<TData, TResult, TConveyorMachine>(ReuseStrategy strategy, int maxParallelMachines = 1,
            int maxPriority = 100, int maxAttempts = int.MaxValue)
            where TData : notnull
            where TConveyorMachine : IConveyorMachine<TData, TResult>
            => (services ?? throw new ArgumentNullException(nameof(services))).AddPriorityConveyor(
                provider => provider.GetRequiredService<TConveyorMachine>(),
                strategy,
                maxParallelMachines,
                maxPriority,
