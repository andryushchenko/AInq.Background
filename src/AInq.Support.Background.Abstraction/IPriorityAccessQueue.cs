...
namespace AInq.Support.Background
{
    public interface IPriorityAccessQueue<out TResource> : IAccessQueue<TResource>
    {
        ...
        Task EnqueueAccess<TAccess>(int priority, CancellationToken cancellation = default, int attemptsCount = 1) where TAccess:IAccess<TResource>;
        ...
        Task<TResult> EnqueueAccess<TAccess, TResult>(int priority, CancellationToken cancellation = default, int attemptsCount = 1) where TAccess:IAccess<TResource, TResult>;
        ...
        Task EnqueueAsyncAccess<TAsyncAccess>(int priority, CancellationToken cancellation = default, int attemptsCount = 1) where TAsyncAccess:IAsyncAccess<TResource>;
        ...
        Task<TResult> EnqueueAsyncAccess<TAsyncAccess, TResult>(int priority, CancellationToken cancellation = default, int attemptsCount = 1) where TAsyncAccess:IAsyncAccess<TResource, TResult>;
    }
}